    ...
    async onFile(file: plugins.File) {
        if (file.extname == '.js') {
            ...
            if (filename == 'libs/modules/egret/egret.js' || filename == 'libs/modules/egret/egret.min.js') {
                ...
                if (filename == "libs/modules/decimal/decimal.js" || filename == 'libs/modules/decimal/decimal.min.js') {
                    content += ";window.decimal = Decimal;"
                }
                if (filename == "libs/modules/ddskd/ddskd.js" ||
                    filename == "libs/modules/ddskd/ddskd.min.js" || 
                    filename == "libs/modules/ddsdk_egret/ddskd_egret.js" || 
                    filename == "libs/modules/ddsdk_egret/ddskd_egret.min.js" ) {
                    content += ";window.DDSDK = DDSDK;"
                }
